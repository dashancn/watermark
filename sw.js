const CACHE_NAME='i41-watermark-original-v4';
const ASSETS=['./','./index.html','./style.css','./src/app.js','./src/watermark.js','./src/heic-core.js','./src/heic-worker-client.js','./manifest.webmanifest'];
